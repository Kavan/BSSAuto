 ...
 */
            ...
            /**
            *  CallDetailWithBundles bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CallDetailWithBundles extends com.redknee.util.crmapi.soap.calldetails.xsd._2011._03.CallDetail
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CallDetailWithBundles
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CallDetailWithBundles",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                                       ...
                                       if (localBundleInfo!=null){
                                            for (int i = 0;i < localBundleInfo.length;i++){
                                                if (localBundleInfo[i] != null){
                                                 localBundleInfo[i].serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/calldetails/xsd/2011/03","bundleInfo"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://soap.crmapi.util.redknee.com/calldetails/xsd/2011/03", "bundleInfo", xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/calldetails/xsd/2011/03","CallDetailWithBundles"));
                 if (localAccountIDTracker){
    ...
    public static class Factory{
        ...
        */
        public static CallDetailWithBundles parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CallDetailWithBundles object =
                new CallDetailWithBundles();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CallDetailWithBundles".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CallDetailWithBundles)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list29 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/calldetails/xsd/2011/03","bundleInfo").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list29.add(com.redknee.util.crmapi.soap.calldetails.xsd._2011._03.ChargedBundleInfo.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone29){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/calldetails/xsd/2011/03","bundleInfo").equals(reader.getName())){
