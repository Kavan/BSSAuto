 ...
 */
            ...
            /**
            *  BillingSystemResult bean class
            */
        ...
        /* This type was generated from the piece of schema that had
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for BillingSystemResultCode
                        */

                        
                                    protected long localBillingSystemResultCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBillingSystemResultCodeTracker = false ;

                           public boolean isBillingSystemResultCodeSpecified(){
                               return localBillingSystemResultCodeTracker;
                           }
                           ...
                           * @return long
                           */
                           public  long getBillingSystemResultCode(){
                               return localBillingSystemResultCode;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param BillingSystemResultCode
                               */
                               public void setBillingSystemResultCode(long param){
                            localBillingSystemResultCodeTracker = true;
                                   
                                            this.localBillingSystemResultCode=param;
                        ...
                        /**
                        * field for BillingSystemResultMessage
                        */

                        
                                    protected java.lang.String localBillingSystemResultMessage ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBillingSystemResultMessageTracker = false ;

                           public boolean isBillingSystemResultMessageSpecified(){
                               return localBillingSystemResultMessageTracker;
                           }
                           ...
                           */
                           public  java.lang.String getBillingSystemResultMessage(){
                               return localBillingSystemResultMessage;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param BillingSystemResultMessage
                               */
                               public void setBillingSystemResultMessage(java.lang.String param){
                            localBillingSystemResultMessageTracker = true;
                                   
                                            this.localBillingSystemResultMessage=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BillingSystemResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BillingSystemResult",
                ...
                if (localParametersTracker){
                                 ...
                                 } if (localBillingSystemResultCodeTracker){
                                    namespace = "http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03";
                                    writeStartElement(null, namespace, "billingSystemResultCode", xmlWriter);
                             
                                               if (localBillingSystemResultCode==java.lang.Long.MIN_VALUE) {
                                           
                                                         writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                                      
                                               } else {
                                                    xmlWriter.writeCharacters(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBillingSystemResultCode));
                                               }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localBillingSystemResultMessageTracker){
                                    namespace = "http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03";
                                    writeStartElement(null, namespace, "billingSystemResultMessage", xmlWriter);
                             

                                          if (localBillingSystemResultMessage==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localBillingSystemResultMessage);
                             ...
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
                                    ...
                                    if (localParameters[i] != null){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03",
                                                                      "billingSystemResultCode"));
                                 
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBillingSystemResultCode));
                            } if (localBillingSystemResultMessageTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03",
                                                                      "billingSystemResultMessage"));
                                 
                                         elementList.add(localBillingSystemResultMessage==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localBillingSystemResultMessage));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static BillingSystemResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BillingSystemResult object =
                new BillingSystemResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BillingSystemResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BillingSystemResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03","billingSystemResultCode").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setBillingSystemResultCode(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToLong(content));
                                            
                                       } else {
                                           
                                           
                                                   object.setBillingSystemResultCode(java.lang.Long.MIN_VALUE);
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03","billingSystemResultMessage").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setBillingSystemResultMessage(
