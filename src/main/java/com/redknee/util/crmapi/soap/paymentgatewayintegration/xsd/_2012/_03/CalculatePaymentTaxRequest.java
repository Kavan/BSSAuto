...
/**
 * CalculatePaymentTaxRequest.java
 *
 ...
 */
            ...
            /**
            *  CalculatePaymentTaxRequest bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CalculatePaymentTaxRequest
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CalculatePaymentTaxRequest
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CalculatePaymentTaxRequest",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CalculatePaymentTaxRequest",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static CalculatePaymentTaxRequest parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CalculatePaymentTaxRequest object =
                new CalculatePaymentTaxRequest();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CalculatePaymentTaxRequest".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CalculatePaymentTaxRequest)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
