 ...
 */
            ...
            /**
            *  ChargingGatewayResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ChargingGatewayResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ChargingGatewayResult
                ...
                */
                        ...
                        */
                        ...
                        /**
                        * field for ChargingGatewayResultCode
                        */

                        
                                    protected java.lang.String localChargingGatewayResultCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localChargingGatewayResultCodeTracker = false ;

                           public boolean isChargingGatewayResultCodeSpecified(){
                               return localChargingGatewayResultCodeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getChargingGatewayResultCode(){
                               return localChargingGatewayResultCode;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ChargingGatewayResultCode
                               */
                               public void setChargingGatewayResultCode(java.lang.String param){
                            localChargingGatewayResultCodeTracker = true;
                                   
                                            this.localChargingGatewayResultCode=param;
                        ...
                        /**
                        * field for ChargingGatewayResultMessage
                        */

                        
                                    protected java.lang.String localChargingGatewayResultMessage ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localChargingGatewayResultMessageTracker = false ;

                           public boolean isChargingGatewayResultMessageSpecified(){
                               return localChargingGatewayResultMessageTracker;
                           }
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getChargingGatewayResultMessage(){
                               return localChargingGatewayResultMessage;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param ChargingGatewayResultMessage
                               */
                               public void setChargingGatewayResultMessage(java.lang.String param){
                            localChargingGatewayResultMessageTracker = true;
                                   
                                            this.localChargingGatewayResultMessage=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ChargingGatewayResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localParametersTracker){
                                 ...
                                 } if (localChargingGatewayResultCodeTracker){
                                    namespace = "http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03";
                                    writeStartElement(null, namespace, "chargingGatewayResultCode", xmlWriter);
                             

                                          if (localChargingGatewayResultCode==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localChargingGatewayResultCode);
                                            
                                          }
                                    
                                   xmlWriter.writeEndElement();
                             } if (localChargingGatewayResultMessageTracker){
                                    namespace = "http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03";
                                    writeStartElement(null, namespace, "chargingGatewayResultMessage", xmlWriter);
                             

                                          if (localChargingGatewayResultMessage==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localChargingGatewayResultMessage);
                             ...
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
                                    ...
                                    if (localParameters[i] != null){
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03",
                                                                      "chargingGatewayResultCode"));
                                 
                                         elementList.add(localChargingGatewayResultCode==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localChargingGatewayResultCode));
                                    } if (localChargingGatewayResultMessageTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03",
                                                                      "chargingGatewayResultMessage"));
                                 
                                         elementList.add(localChargingGatewayResultMessage==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localChargingGatewayResultMessage));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static ChargingGatewayResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ChargingGatewayResult object =
                new ChargingGatewayResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ChargingGatewayResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ChargingGatewayResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03","chargingGatewayResultCode").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setChargingGatewayResultCode(
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/PaymentGatewayIntegration/xsd/2012/03","chargingGatewayResultMessage").equals(reader.getName())){
                                    ...
                                    java.lang.String content = reader.getElementText();
                                              ...
                                              object.setChargingGatewayResultMessage(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
