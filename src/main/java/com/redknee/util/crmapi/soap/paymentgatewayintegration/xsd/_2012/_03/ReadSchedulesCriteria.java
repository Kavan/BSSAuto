 ...
 */
            ...
            /**
            *  ReadSchedulesCriteria bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReadSchedulesCriteria
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = ReadSchedulesCriteria
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ReadSchedulesCriteria",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ReadSchedulesCriteria",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static ReadSchedulesCriteria parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReadSchedulesCriteria object =
                new ReadSchedulesCriteria();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReadSchedulesCriteria".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReadSchedulesCriteria)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
