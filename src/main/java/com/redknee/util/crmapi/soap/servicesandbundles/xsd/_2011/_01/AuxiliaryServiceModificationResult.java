...
/**
 * AuxiliaryServiceModificationResult.java
 *
 ...
 */
            ...
            /**
            *  AuxiliaryServiceModificationResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class AuxiliaryServiceModificationResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = AuxiliaryServiceModificationResult
                ...
                */
                        ...
                        /**
                        * field for AuxiliaryService
                        */

                        
                                    protected com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.AuxiliaryService localAuxiliaryService ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localAuxiliaryServiceTracker = false ;

                           public boolean isAuxiliaryServiceSpecified(){
                               return localAuxiliaryServiceTracker;
                           }
                           ...
                           * @return com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.AuxiliaryService
                           */
                           public  com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.AuxiliaryService getAuxiliaryService(){
                               return localAuxiliaryService;
                           }
                            ...
                            /**
                               ...
                               * @param param AuxiliaryService
                               */
                               public void setAuxiliaryService(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.AuxiliaryService param){
                            localAuxiliaryServiceTracker = true;
                                   
                                            this.localAuxiliaryService=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":AuxiliaryServiceModificationResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "AuxiliaryServiceModificationResult",
                           xmlWriter);
                   }

               
                   }
                if (localAuxiliaryServiceTracker){
                                    if (localAuxiliaryService==null){

                                        writeStartElement(null, "http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01", "auxiliaryService", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localAuxiliaryService.serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","auxiliaryService"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localAuxiliaryServiceTracker){
                            elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01",
                                    ...
                                    elementList.add(localAuxiliaryService==null?null:
                                    localAuxiliaryService);
                                } if (localParametersTracker){
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static AuxiliaryServiceModificationResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            AuxiliaryServiceModificationResult object =
                new AuxiliaryServiceModificationResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"AuxiliaryServiceModificationResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (AuxiliaryServiceModificationResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","auxiliaryService").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setAuxiliaryService(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setAuxiliaryService(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.AuxiliaryService.Factory.parse(reader));
