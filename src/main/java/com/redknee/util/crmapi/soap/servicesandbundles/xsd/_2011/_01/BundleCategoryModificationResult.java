...
/**
 * BundleCategoryModificationResult.java
 *
 ...
 */
            ...
            /**
            *  BundleCategoryModificationResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BundleCategoryModificationResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = BundleCategoryModificationResult
                ...
                */
                        ...
                        /**
                        * field for BundleCategory
                        */

                        
                                    protected com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.BundleCategory localBundleCategory ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localBundleCategoryTracker = false ;

                           public boolean isBundleCategorySpecified(){
                               return localBundleCategoryTracker;
                           }
                           ...
                           * @return com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.BundleCategory
                           */
                           public  com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.BundleCategory getBundleCategory(){
                               return localBundleCategory;
                           }
                            ...
                            /**
                               ...
                               * @param param BundleCategory
                               */
                               public void setBundleCategory(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.BundleCategory param){
                            localBundleCategoryTracker = true;
                                   
                                            this.localBundleCategory=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":BundleCategoryModificationResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "BundleCategoryModificationResult",
                           xmlWriter);
                   }

               
                   }
                if (localBundleCategoryTracker){
                                    if (localBundleCategory==null){

                                        writeStartElement(null, "http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01", "bundleCategory", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localBundleCategory.serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","bundleCategory"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localBundleCategoryTracker){
                            elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01",
                                    ...
                                    elementList.add(localBundleCategory==null?null:
                                    localBundleCategory);
                                } if (localParametersTracker){
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static BundleCategoryModificationResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            BundleCategoryModificationResult object =
                new BundleCategoryModificationResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"BundleCategoryModificationResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (BundleCategoryModificationResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","bundleCategory").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setBundleCategory(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setBundleCategory(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.BundleCategory.Factory.parse(reader));
