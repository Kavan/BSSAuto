...
/**
 * PricePlanDependencyGroupModificationResult.java
 *
 ...
 */
            ...
            /**
            *  PricePlanDependencyGroupModificationResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PricePlanDependencyGroupModificationResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PricePlanDependencyGroupModificationResult
                ...
                */
                        ...
                        /**
                        * field for DependencyGroup
                        */

                        
                                    protected com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanDependencyGroup localDependencyGroup ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDependencyGroupTracker = false ;

                           public boolean isDependencyGroupSpecified(){
                               return localDependencyGroupTracker;
                           }
                           ...
                           * @return com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanDependencyGroup
                           */
                           public  com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanDependencyGroup getDependencyGroup(){
                               return localDependencyGroup;
                           }
                            ...
                            /**
                               ...
                               * @param param DependencyGroup
                               */
                               public void setDependencyGroup(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanDependencyGroup param){
                            localDependencyGroupTracker = true;
                                   
                                            this.localDependencyGroup=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PricePlanDependencyGroupModificationResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PricePlanDependencyGroupModificationResult",
                           xmlWriter);
                   }

               
                   }
                if (localDependencyGroupTracker){
                                    if (localDependencyGroup==null){

                                        writeStartElement(null, "http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01", "dependencyGroup", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localDependencyGroup.serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","dependencyGroup"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localDependencyGroupTracker){
                            elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01",
                                    ...
                                    elementList.add(localDependencyGroup==null?null:
                                    localDependencyGroup);
                                } if (localParametersTracker){
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static PricePlanDependencyGroupModificationResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PricePlanDependencyGroupModificationResult object =
                new PricePlanDependencyGroupModificationResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PricePlanDependencyGroupModificationResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PricePlanDependencyGroupModificationResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","dependencyGroup").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setDependencyGroup(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setDependencyGroup(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanDependencyGroup.Factory.parse(reader));
