...
/**
 * PricePlanModificationResult.java
 *
 ...
 */
            ...
            /**
            *  PricePlanModificationResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PricePlanModificationResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PricePlanModificationResult
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlan localPricePlan ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localPricePlanTracker = false ;

                           public boolean isPricePlanSpecified(){
                               return localPricePlanTracker;
                           }
                           ...
                           */
                           public  com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlan getPricePlan(){
                            ...
                            /**
                               ...
                               * @param param PricePlan
                               */
                               public void setPricePlan(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlan param){
                            localPricePlanTracker = true;
                                   
                                            this.localPricePlan=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PricePlanModificationResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PricePlanModificationResult",
                           xmlWriter);
                   }

               
                   }
                if (localPricePlanTracker){
                                    if (localPricePlan==null){

                                        writeStartElement(null, "http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01", "pricePlan", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localPricePlan.serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","pricePlan"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localPricePlanTracker){
                            elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01",
                                    ...
                                    elementList.add(localPricePlan==null?null:
                                    localPricePlan);
                                } if (localParametersTracker){
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static PricePlanModificationResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PricePlanModificationResult object =
                new PricePlanModificationResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PricePlanModificationResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PricePlanModificationResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","pricePlan").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setPricePlan(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setPricePlan(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlan.Factory.parse(reader));
