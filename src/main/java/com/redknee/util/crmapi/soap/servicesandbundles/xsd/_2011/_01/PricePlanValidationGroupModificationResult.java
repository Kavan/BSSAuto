...
/**
 * PricePlanValidationGroupModificationResult.java
 *
 ...
 */
            ...
            /**
            *  PricePlanValidationGroupModificationResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class PricePlanValidationGroupModificationResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = PricePlanValidationGroupModificationResult
                ...
                */
                        ...
                        /**
                        * field for ValidationGroup
                        */

                        
                                    protected com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanValidationGroup localValidationGroup ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localValidationGroupTracker = false ;

                           public boolean isValidationGroupSpecified(){
                               return localValidationGroupTracker;
                           }
                           ...
                           * @return com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanValidationGroup
                           */
                           public  com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanValidationGroup getValidationGroup(){
                               return localValidationGroup;
                           }
                            ...
                            /**
                               ...
                               * @param param ValidationGroup
                               */
                               public void setValidationGroup(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanValidationGroup param){
                            localValidationGroupTracker = true;
                                   
                                            this.localValidationGroup=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":PricePlanValidationGroupModificationResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "PricePlanValidationGroupModificationResult",
                           xmlWriter);
                   }

               
                   }
                if (localValidationGroupTracker){
                                    if (localValidationGroup==null){

                                        writeStartElement(null, "http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01", "validationGroup", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localValidationGroup.serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","validationGroup"),
                                        xmlWriter);
                                    }
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localValidationGroupTracker){
                            elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01",
                                    ...
                                    elementList.add(localValidationGroup==null?null:
                                    localValidationGroup);
                                } if (localParametersTracker){
                             if (localParameters!=null) {
                                 for (int i = 0;i < localParameters.length;i++){
    ...
    public static class Factory{
        ...
        */
        public static PricePlanValidationGroupModificationResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            PricePlanValidationGroupModificationResult object =
                new PricePlanValidationGroupModificationResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"PricePlanValidationGroupModificationResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (PricePlanValidationGroupModificationResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list2 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/servicesandbundles/xsd/2011/01","validationGroup").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setValidationGroup(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setValidationGroup(com.redknee.util.crmapi.soap.servicesandbundles.xsd._2011._01.PricePlanValidationGroup.Factory.parse(reader));
