...
/**
 * SubscriptionStateTransitionResult.java
 *
 ...
 */
            ...
            /**
            *  SubscriptionStateTransitionResult bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SubscriptionStateTransitionResult
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = SubscriptionStateTransitionResult
                ...
                */
                        ...
                        */
                                    ...
                                    protected com.redknee.util.crmapi.soap.subscriptions.xsd._2009._04.SubscriptionState localOldState ;
                          ...
                          *   for this attribute. It will be used to determine whether to include this field
                           ...
                           */
                           public  com.redknee.util.crmapi.soap.subscriptions.xsd._2009._04.SubscriptionState getOldState(){
                            ...
                            /**
                               ...
                               */
                               public void setOldState(com.redknee.util.crmapi.soap.subscriptions.xsd._2009._04.SubscriptionState param){
                            localOldStateTracker = true;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":SubscriptionStateTransitionResult",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                ...
                if (localParametersTracker){
                                    ...
                                    if (localOldState==null){
                                        ...
                                        writeStartElement(null, "http://soap.crmapi.util.redknee.com/subscriptions/xsd/2011/01", "oldState", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localOldState.serialize(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/subscriptions/xsd/2011/01","oldState"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localParametersTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/subscriptions/xsd/2011/01",
                                    ...
                                    elementList.add(localOldState==null?null:
                                    localOldState);
                                }
    ...
    public static class Factory{
        ...
        */
        public static SubscriptionStateTransitionResult parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubscriptionStateTransitionResult object =
                new SubscriptionStateTransitionResult();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"SubscriptionStateTransitionResult".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SubscriptionStateTransitionResult)com.redknee.util.crmapi.soap.common.xsd.common_v2_0.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://soap.crmapi.util.redknee.com/subscriptions/xsd/2011/01","oldState").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setOldState(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setOldState(com.redknee.util.crmapi.soap.subscriptions.xsd._2009._04.SubscriptionState.Factory.parse(reader));
